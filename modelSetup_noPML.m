function output = modelSetup_noPML(model, binaryImage, geom_params)
%%%%%%%%%%%%%%%%%%%%%%%%%% Set up model parameter %%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    comp1.coordSystem('pml1').selection.set([5 6]);
    ...
    comp1.physics('solid').feature('pzm1').selection.set([1 2 3 4 5 6]);
    ...
    mesh1.feature('ftri1').selection.set([9]);
    ...
    mesh1.feature('bl1').feature('blp').selection.set([16 outElabels(1) outElabels(2)]);
    ...
    mesh1.create('bl2', 'BndLayer');%mesh for wavguide PML boundary
    mesh1.feature('bl2').selection.geom('geom1', 2);
    mesh1.feature('bl2').selection.set(pmlMeshBlabels);
    mesh1.feature('bl2').create('blp', 'BndLayerProp');
    mesh1.feature('bl2').feature('blp').selection.set(pmlElabels);
    mesh1.feature('bl2').feature('blp').set('blnlayers', 3);
    mesh1.feature('bl2').feature('blp').set('blstretch', 1.5);
    mesh1.feature('bl2').feature('blp').set('blhminfact', 1.5);

    mesh1.create('swe1', 'Sweep');% sweep the mesh
    mesh1.feature('swe1').selection.geom('geom1', 3);
    mesh1.feature('swe1').selection.add([1 2 3 4 5 6]);
